...
//            SupervisedModels.Utilities.writeMatrixToFile(xVals, yActual, "Etc.test.csv");
            Matrix fitW = sgd(trainPoints, yTrain);
//            SupervisedModels.Utilities.writeMatrixToFile(fitW, "testW.csv");
...
//            SupervisedModels.Utilities.printArr(SupervisedModels.Utilities.flattenArr(w));
        }
        numEpochs.add(j);
        return w;
    }
